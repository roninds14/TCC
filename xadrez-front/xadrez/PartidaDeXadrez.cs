...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        private void colocarPecas()
        {
            ...
            colocarNovaPeca('a', 6, new Cavalo(tab, Cor.Preta));
            //colocarNovaPeca('c', 8, new Bispo(tab, Cor.Preta));
            //colocarNovaPeca('d', 8, new Dama(tab, Cor.Preta));
            colocarNovaPeca('b', 6, new Rei(tab, Cor.Preta, this));
            //colocarNovaPeca('f', 8, new Bispo(tab, Cor.Preta));
            colocarNovaPeca('c', 6, new Cavalo(tab, Cor.Preta));
            //colocarNovaPeca('h', 8, new Torre(tab, Cor.Preta));
            colocarNovaPeca('a', 5, new Peao(tab, Cor.Preta, this));
            colocarNovaPeca('b', 5, new Peao(tab, Cor.Preta, this));
